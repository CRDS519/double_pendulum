...
class Pendulum:
    def __init__(self, angle1, angle2, l1, l2, d1, d2, m1, m2, i1, i2, g, pendulum_type, model, scale, friction):
    ...
    def move_pendulum(self, dt):
        if self.pendulum_type == 'Simple':
            if self.model == 'Classic':
                ...
                args = (self.g, self.l1, self.friction)
            else:
                f = f_simple_physic_pendulum
                rk4 = rk4_simple_physic_pendulum
                args = (self.g, self.l1, self.d1, self.m1, self.i1, self.friction)
            ...
            if self.model == 'Classic':
                ...
                args = (self.g, self.l1, self.l2, self.m1, self.m2, self.friction)
            else:  # self.model == 'Physic'
                f = f_double_physic_pendulum
                rk4 = rk4_double_physic_pendulum
                args = (self.g, self.l1, self.l2, self.d1, self.d2, self.m1, self.m2, self.i1, self.i2, self.friction)
